...
export default function AdminUsersPage() {
  ...
  return (
    <div>
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="glass-panel mt-6 grid gap-3 rounded-xl p-4 sm:grid-cols-2">
          <input
            type="text"
            required
      ...
      <div className="glass-panel mt-6 overflow-hidden rounded-xl">
        {loading ? (
          ...
          <table className="w-full text-sm">
            <thead className="bg-black/[0.02] text-left text-xs uppercase tracking-wide text-muted dark:bg-white/[0.03]">
              <tr>
